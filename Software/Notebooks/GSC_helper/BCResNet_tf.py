    ...
    def __init__(self,
        ...
        self.net = keras.Sequential([keras.layers.Conv2D(filters = int(16*mul_factor),
                                 ...
                                 BCResBlock(int(16*mul_factor),
                                            ...
                                            bias = bias,
                                            ssn_kwargs = {
                                                'normalized_shape': (20, 101, int(8*mul_factor)),
                                                'spec_groups': 5
                                            },
                                            num_blks = 2,
                                            idx = 0),
                                 BCResBlock(int(8*mul_factor),
                                            ...
                                            bias = bias,
                                            ssn_kwargs = {
                                                'normalized_shape': (10, 101, int(12*mul_factor)),
                                                'spec_groups': 5
                                            },
                                            num_blks = 2,
                                            idx = 1),
                                 BCResBlock(int(12*mul_factor),
                                            ...
                                            bias = bias,
                                            ssn_kwargs = {
                                                'normalized_shape': (5, 101, int(16*mul_factor)),
                                                'spec_groups': 5
                                            },
                                            num_blks = 4,
                                            idx = 2),
                                 BCResBlock(int(16*mul_factor),
                                            ...
                                            bias = False,
                                            ssn_kwargs = {
                                                'normalized_shape': (5, 101, int(20*mul_factor)),
                                                'spec_groups': 5
                                            },
                                            num_blks = 4,
                                          idx = 3),
